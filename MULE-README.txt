...
-----------------------------------------------------------------
./src/test/java/nz/org/geonet/mulesqstestclient/MulesqstestclientTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/mulesqstestclient-functional-test-config.xml

Defines the Mule configuration for the MulesqstestclientTestCase.java.
...
artifactId=mulesqstestclient
description=Listens to AWS SQS queues.
muleVersion=3.2.0
packagePath=com/mycompany/mule
forgeProject=n
transports=file,http,jdbc,jms,vm,stdio
modules=client,cxf,management,scripting,sxc,xml

version=1.0-SNAPSHOT
groupId=nz.org.geonet
basedir=/home/geoffc/GeoNet
--------------------------------------------------------------------